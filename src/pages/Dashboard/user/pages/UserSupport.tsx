...
const handleSubmit = async (e: any) => {
  ...
  return (
    ...
    {loadingSup ? (
      ...
      <div>
    <div className='container py-6 w-full md:w-3/4 mx-auto'>
        <p className='text-center text-3xl font-[Jost] font-[600] pb-4'>Support</p>
        <div className="w-full">
            <form className="w-full border border-primary p-4 rounded-lg shadow-lg flex flex-col gap-4 bg-[#f1f1f1] dark:bg-[#1f2937]" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-2">
                    <label className="font-[500] font-[Jost] md:text-xl text-md">Subject</label>
                ...
                <div>
                    <select name="" id="" className="w-full p-2 rounded-lg border border-primary font-[500] font-[Jost] md:text-xl text-md" onChange={(e) => setCategory(e.target.value)} value={category} required>
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-[500] font-[Jost] md:text-xl text-md">Message</label>
                ...
                <button className="py-4 px-8 rounded-2xl bg-primary font-[500] md:text-xl text-md">{loading ? "Submitting..." : "Submit"}</button>
            </form>
        </div>
        </div>    
        <FooterCR />
