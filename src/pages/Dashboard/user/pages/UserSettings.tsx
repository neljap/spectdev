    ...
    {profilePicState && (<div className='fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center'>
            <div className='w-80 rounded-xl h-40 bg-[#f1f1f1] dark:bg-[#1f2937] flex flex-col justify-center items-center gap-8'>
                ...
                <div className='flex justify-between items-center px-8 gap-4'>
                    <button className='bg-primary px-4 py-2 rounded-xl' onClick={handleUploadPics}>Yes</button>
                    <button className='bg-red-500 px-4 py-2 rounded-xl' onClick={() => setProfilePicState(false)}>No</button>
                </div>
            </div>
        </div>)}
    </>
